...
// Predefined list of 24 colors
  ...
  <main>
        <div>
            ...
            <button style=" border-radius: 10px; margin-top:15px; padding: 10px 60px; background-color:midnightblue; color:white;" on:click={handleSave}>Save</button>
            <button style=" border-radius: 10px; margin-top:15px; padding: 10px 60px; background-color:midnightblue; color:white;" on:click={()=>resetPixels(size)}>Reset</button>
